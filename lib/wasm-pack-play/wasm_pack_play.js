...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_origin_bf96396097564416 = function(arg0, arg1) {
    ...
    imports.wbg.__wbg_origin_e2ef636cf9fe83ab = function(arg0, arg1) {
        const ret = arg1.origin;
        const ptr1 = passStringToWasm0(ret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        getDataViewMemory0().setInt32(arg0 + 4 * 1, len1, true);
    ...
    imports.wbg.__wbg_random_46009c04228d172b = function() {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wasm_pack_play_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
